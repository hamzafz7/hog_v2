...
class ShowCourseVideo extends StatefulWidget {
  const ShowCourseVideo({Key? key, this.description, this.name})
      : super(key: key);
...
class _ShowCourseVideoState extends State<ShowCourseVideo> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: Obx(() {
          final videoStatus = showLessonController.watchVideoStatus.value;
                ...
                children: [
                  AspectRatio(
                    ...
                    child: showLessonController.podPlayerController != null
                        ? PodVideoPlayer(
                            controller:
                                showLessonController.podPlayerController!,
          ...
          } else if (videoStatus == RequestStatus.loading) {
